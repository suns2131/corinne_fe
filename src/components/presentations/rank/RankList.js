...
function RankList() {
  ...
  return (
    <div className="w-full h-[839px] flex flex-col mx-5 mt-[19px] ">
      {realData?.rank &&
        realData.rank.map((el, idx) => (
          <div>
            {idx === 0 && (
              <div
                id={el.id}
                className=" w-[753px] h-[64px] mb-[15px] bg-curp rounded-[10px] p-5 flex justify-between items-center"
              >
                ...
                <div className="w-[60px] h-[64px] flex justify-center items-center">
                  <div>
                    ...
                    >
                      <path
                        d="M8.92664 1.38676C8.34664 1.21343 7.70664 1.1001 6.99997 1.1001C3.80664 1.1001 1.21997 3.68676 1.21997 6.8801C1.21997 10.0801 3.80664 12.6668 6.99997 12.6668C10.1933 12.6668 12.78 10.0801 12.78 6.88676C12.78 5.7001 12.42 4.59343 11.8066 3.67343"
                        stroke="#CECECE"
                        strokeWidth="1.5"
                        strokeLinecap="round"

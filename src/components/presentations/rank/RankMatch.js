    ...
    return (
        ...
        {matchData && 
            ...
            <div className="w-[164.5px] h-[100px] bg-curp rounded-tl-[10px] rounded-bl-[10px] flex flex-col justify-center items-center">
                ...
                <p className="font-bold text-[20px] text-[#ffffff]">{matchData?.winner?.fluctuationRate}%</p>
            </div>
            ...
            <div className="flex justify-center item_center">
                ...
                <p className="font-bold text-[20px] text-[#ffffff]">{matchData?.loser?.fluctuationRate}%</p>
            </div>
            <div className=" absolute left-[80%] top-[58%]"

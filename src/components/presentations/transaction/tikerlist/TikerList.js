      ...
      <div className=" w-[387px] h-[114px] flex flex-col items-start p-5 gap-[10px]  shadow-008 rounded-t-[10px]">
        <div className="w-[347px] h-[74px] mb-[10px]">
          <div className="flex mb-[10px]">
            <button
              className={`w-[65px] h-[32px] mr-[10px] ${btnStat.all} border border-solid border-[#eeeeee] rounded-[6px] text-[12px] font-normal hover:bg-[#eeeeee]`}
              onClick={() => {
                setBtnStat({
                  all: 'bg-[#eeeeee]',
                  favor: 'bg-[#ffffff]',
            ...
            <button
              className={`w-[65px] h-[32px] mr-[10px] ${btnStat.favor}  border border-solid border-[#eeeeee] rounded-[6px] text-[12px] font-normal hover:bg-[#eeeeee]`}
              onClick={() => {
                setBtnStat({
                  all: 'bg-[#ffffff]',
                  favor: 'bg-[#eeeeee]',
              ...
              >
                <div className={styles.TikeritemDiv}>
                  ...
                  <div className={styles.TikeritemPrice}>
                    {el.upRate > 0 ? (
                      <p className="font-bold text-[15px] text-Primary-purple2">
                        {Won(el.price)}원
                      </p>
                    ) : (
                      <p className="font-bold text-[15px] text-Secondary-orange">
                        {Won(el.price)}원
                      </p>
                    )}

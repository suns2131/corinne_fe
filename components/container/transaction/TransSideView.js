            ...
            <div className='w-full h-[395px] p-5 rounded-b-xl bg-neutrals5'>
              <div>
                <div className='flex justify-between items-center'>
                    <p className=' text-[#ff9e0d] font-bold text-[15px]'>매도</p>
                    <p className=' text-[#cecece] text-[12px]'>0000.00.00 00:00</p>
                </div>
                <div className='flex justify-between items-center mb-[4px]'>
                    <p className='text-[#cecece] text-[14px]'>체결가격</p>
                    <p className=' text-[#33323F] text-[15px] font-bold'> 1,000,000원</p>
                </div>
                <div className='flex justify-between items-center mb-[4px]'>
                    <p className='text-[#cecece] text-[14px]'>체결금액</p>
                    <p className=' text-[#33323F] text-[15px] font-bold'>100,000원</p>
                </div>
                <div className='flex justify-between items-center mb-[24px]'>
                    <p className='text-[#cecece] text-[14px]'>레버리지</p>
                    <p className=' text-[#33323F] text-[15px] font-bold'>1x</p>
                </div>
              </div>
              <div>
                <div className='flex justify-between items-center'>

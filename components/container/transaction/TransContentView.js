          ...
          <div className=" w-[387px] h-[587px] my-5">
            <div className=" w-full h-[114px] p-5 bg-white rounded-t-xl shadow-md">    
              <div className=" flex justify-start items-center">
                <button type="button" className=" border-solid border-[#eeeeee] border-[1px] text-btnxs  px-[10px] py-[9px] mr-[10px] rounded-md active:bg-[#eeeeee] ">전체 종목</button>
                <button type="button" className=" border-solid border-[#eeeeee] border-[1px] text-btnxs px-[10px] py-[9px] mr-[10px] rounded-md" >관심 종목</button>
              </div>
            ...
            <div className=" w-full h-[474px] bg-white drop-shadow-md overflow-y-scroll">
            {coinList && coinList.map((el,idx) =>(
                  <div key={el} className=" w-full h-[90px] p-5 flex justify-between items-cente hover:bg-[#FBF6FF]  ">
                  <div className=" flex ">

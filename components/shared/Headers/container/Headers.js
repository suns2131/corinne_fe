...
export default function Headers() {
    ...
    return (
      <div className=' font-Pretendard w-full h-headers py-4 flex justify-between items-center '>
        <div className=' text-base text-curp font-bold' >
          corinne
        </div>
          <nav className=' '>
            <ul className=' list-none '>
              {router.pathname === "/transaction" ?
                 ...
                 :
                 <li className=' float-left text-menus mt-2 mr-[41px] '><Link href="/transaction">모의투자</Link></li>
              } 
              {router.pathname === "/RankPage" ?
                 <li className=' float-left text-menus mt-2 mr-[41px] font-bold '><Link href="/RankPage">랭킹</Link></li>
                 :
                 <li className=' float-left text-menus mt-2 mr-[41px] '><Link href="/RankPage">랭킹</Link></li>
              }
              <li className=' float-left text-menus mt-2 mr-[41px] '>커뮤니티</li>
              <li className=' float-left text-menus mt-2 mr-[37px] '>로그아웃</li>
